...
const saveJoke = () => {
  ...
  const exists = saved.some(
    (j: Joke) => j.setup === joke.value?.setup && j.punchline === joke.value?.punchline
  );
...
<template>
  <div
    class="max-w-md mx-auto dark:bg-gray-800 rounded-xl shadow-md overflow-hidden md:max-w-2xl p-6"
  >
